...
console.log('Use this link to add the bot to a discord server: https://discordapp.com/oauth2/authorize?274794772424556544
='+config.get('discord.clientid')+'&scope=bot&permissions=8');
